...
class MultiSpawning(Node):
	...
	def __init__(self):
		...
		self.teleport = self.create_client(TeleportAbsolute, '/turtle1/telport_absolute')
	...
	def callback_service(self, request, response):
		...
		x, y, theta = self.calc_position(request.num, 3.0)
